...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/board/boardWriteAction.do")) {
		    ...
		    int value = bd.insertBoard(subject,content,writer,ip,midx,fileName,tag);
            int value2 = bd.boardpoint(midx);
		    int value3 = bd.autolevel(midx);			
		    ...
		    String writer = multipartRequest.getParameter("writer");
		    String tag = multipartRequest.getParameter("tag");
		    String bidx = multipartRequest.getParameter("bidx");
		    ...
		    System.out.println(subject+";"+content+";"+writer+";"+bidx_+fileName);
		
		    String ip = InetAddress.getLocalHost().getHostAddress();   
		    BoardDao bd = new BoardDao();
		    int value = bd.BoardModify(subject, content, writer, ip, midx, bidx_,fileName);
	    ...
	    System.out.println(subject+";"+content+";"+writer+";"+originbidx+";"+depth+";"+level_+";"+tag);
        ...
        int value2 = bd.boardreplypoint(midx);	
        int value3 = bd.autolevel(midx);
        if (value ==1&&value2==1&&value3==1){
	    	response.sendRedirect(request.getContextPath()+"/board/boardList.do");
