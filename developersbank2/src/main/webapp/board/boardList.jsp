<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import = "developersbank2.*"%> <!-- boardDao생성을 위함 -->
...
<title>Welcome to DB!</title>
	...
	<body>
		...
		<table border="0" width="1000px" align="center">
			<tr>
				<td><b>|&nbsp;<a href="<%=request.getContextPath() %>/home.jsp">DB</a></b>&nbsp;&nbsp;&nbsp;Study</td>
			</tr>
			...
			<tr>
				<td>					
					<span style="float: right;"><input type="button"  name="write" value="글쓰기" onclick="location.href='<%=request.getContextPath() %>/board/boardWrite.do'" style="width:100px;"></span>
				</td>
			</tr>
			<tr>
				<td>
