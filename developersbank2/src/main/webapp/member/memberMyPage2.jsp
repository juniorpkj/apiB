...
<HTML>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  function check(){
	  var fm= document.frm;
	  fm.action = "<%=request.getContextPath()%>/member/memberMyPage2.do"
	  fm.method = "post";
	  fm.submit();
  }
  </script>
...
<table border="0" width="800px" align="center">
 ...
 <tr><td style="border:1px solid; height:1px;text-align:center;" colspan="3"><b>&#60;Study&#62;</b> </td></tr>
 ...
 <div>
	...
	&nbsp;
	<span><input type="submit" name="submit" value="검색" onclick="check3();"></span>
	</div>
 </td></tr>
 <tr>
	  <td>
      ...
      <td style="text-align:center;"><%=bv.getTag() %></td>
      <td>
    <%
...
String searchType = pm.getScri().getSearchType();
 ...
 if(pm.isPrev() == true){
	 out.println("<a href ='"+request.getContextPath()+"/member/memberMyPage2.do?page="+(pm.getStartPage()-1)+"&keyword="+keyword+"&searchType="+searchType+"'>◀</a>");
 }
%>
</td>
<td><% 
for(int i = pm.getStartPage(); i<=pm.getEndPage(); i++){
  out.println("<a href ='"+request.getContextPath()+"/member/memberMyPage2.do?page="+i+"&keyword="+keyword+"&searchType="+searchType+"'>"+i+"</a>");
...
if (pm.isNext()&&pm.getEndPage() >0){
   out.println("<a href ='"+request.getContextPath()+"/member/memberMyPage2.do?page="+(pm.getEndPage()+1)+"&keyword="+keyword+"&searchType="+searchType+"'>▶</a>");
}
%></td>
</tr>
 </table>
